...
export const resultPlaceholders: Record<ResultKey, { title: string; header: string; description: string; image: string }> = {
  Tilde1: { title: "Tilde1", header: 'ML Researcher в Tilde', description: `Вы — ML Researcher в Tilde!
...
Диплом межнара (IMO/IOI/ICPC) или другой мощный сигнал интеллектуальной одарённости

Опыт в ML-ресёрче

Зарплата $150k–220k + много equity. Офис в США, помогают с визой, возможен ремоут.`,

image: '/lunaparkmlquiz/assets/results/tilde1.png' },
  Tilde2: { title: 'Tilde2', header: 'ML Engineer в Tilde', description: `Вы — ML Engineer в Tilde!
...
Умение справляться с задачами в команде очень умных людей

Зарплата $130k–200k + опционы. Офис в Лондоне, релокация по Global Talent.`, 
image: '/lunaparkmlquiz/assets/results/recraft1.png' },

Recraft2: { title: 'Recraft2', header: 'Neural Network Optimization Engineer в Recraft', description: `Вы — Neural Network Optimization Engineer в Recraft!
Recraft — стартап из Лондона, который делает AI-инструмент для дизайнеров. Их собственная text-to-image модель уже успела обойти на арене DALL-E, Midjourney и Flux. Больше 3 миллионов пользователей, недавний Series B раунд на $30M, и очень крутая техническая команда во главе с бывшей главой разработки CatBoost.
...
знаете техники квантизации;
 ну очень хорошо разбираетесь в архитектуре GPU, пишете CUDA и знаете Triton. 
    ...
    Зарплата $130k–200k + опционы. Офис в Лондоне, релокация по Global Talent.`
    , image: '/lunaparkmlquiz/assets/results/recraft2.png' },
  Tzafon1: { title: 'Tzafon1', header: 'ML Researcher / Engineer в Tzafon', description: `Вы — ML Researcher в Tzafon!
...
Вилка $150k–500k + equity, релокация в США или Израиль, иногда возможен ремоут.`, image: '/lunaparkmlquiz/assets/results/recraft1.png' },
  Tzafon2: { title: 'Tzafon2', header: 'Infrastructure Engineer в Tzafon', description: `Вы — Infrastructure Engineer в Tzafon!
...
Вилка $150k–500k + equity, релокация в США или Израиль, возможен ремоут.`, image: '/lunaparkmlquiz/assets/results/tzafon2.png' },
  Atla: { title: 'Atla', header: 'Chief Scientist в Atla', description: `Вы — Chief Scientist в Atla!
...
Платят $250k–380k + equity. Помогают с визой и релокацией в Лондон.`, image: '/lunaparkmlquiz/assets/results/atla.png' },
 

  Safer: { title: 'Safer', header: 'Research Engineer в Safer', description: `Вы — Research Engineer в Safer!
...
Несколько публикаций по ML (или диплом IMO/IOI уровня)

Опыт в программировании и ML-фреймворках (PyTorch, Transformers и т.д.)

Умение писать техтексты и проводить ресёрч

Вилка — €60k–95k в год. Париж или ремоут.`,
image: '/lunaparkmlquiz/assets/results/recraft1.png' },


  Eternis: { title: 'Eternis', header: 'ML Engineer в Eternis', description: `Вы — ML Engineer в Eternis!
...
Либо опыт founding engineer'ом, авторство заметного опенсорса или цитируемые статьи

Большой интерес к AI и понимание срочности происходящего

Вилка $120k–800k + equity. Офис в Сан-Франциско, иногда возможен ремоут, помогают с визой.`, image: '/lunaparkmlquiz/assets/results/eternis.png' },

  Epoch: { title: 'Epoch', header: 'Senior Researcher в Epoch', description: `Вы — Senior Researcher в Epoch!
...
Вы попадёте в команду Data Insights — ту самую, что отвечает за отчёты о compute, датасетах и кривых роста.
...
Способность доносить результаты как для ресёрчеров, так и для широкой аудитории

Вилк $150k–200k в год, удалёнка или релокация в US/UK`,
 image: '/lunaparkmlquiz/assets/results/recraft1.png' },


Metr: { title: 'Metr', header: 'ML Engineer в METR', description: `Вы — ML Engineer в METR!
...
Публикации не обязательны, но будут плюсом

Вилка $150k–365k + виза без лотереи. Офис в Беркли, иногда возможен ремоут.`,
 image: '/lunaparkmlquiz/assets/results/metr.png' },
};

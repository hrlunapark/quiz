...
export const resultPlaceholders: Record<ResultKey, { title: string; description: string; image: string }> = {
  Tilde1: { title: 'ML Researcher в Tilde', description: `Вы — ML Researcher в Tilde!
...
Навыки программирования (особенно Python, PyTorch)

Сейчас особенно приветствуется опыт в ML-ресёрче

Зарплата $150k–220k + много equity. Офис в США, помогают с визой, возможен ремоут.

Хотите откликнуться? Напишите @name.
Хотите ещё вакансий? У нас есть телеграм и джобборд.`, image: '/lunaparkmlquiz/assets/results/tilde1.png' },
  Tilde2: { title: 'ML Engineer в Tilde', description: `Вы — ML Engineer в Tilde!
...
Хотите откликнуться? Напишите @name.
Хотите ещё вакансий? У нас есть телеграм и джобборд.`, image: '/lunaparkmlquiz/assets/results/tilde2.png' },
...
Хотите откликнуться? Напишите @name.
Хотите ещё вакансий? У нас есть телеграм и джобборд.`, image: '/lunaparkmlquiz/assets/results/recraft1.png' },
  Recraft2: { title: 'Recraft2', description: 'Placeholder description for Recraft2.', image: '/lunaparkmlquiz/assets/results/recraft2.png' },
  Tzafon1: { title: 'Tzafon1', description: 'Placeholder description for Tzafon1.', image: '/lunaparkmlquiz/assets/results/recraft1.png' },
  Tzafon2: { title: 'Tzafon2', description: 'Placeholder description for Tzafon2.', image: '/lunaparkmlquiz/assets/results/tzafon2.png' },
  Atla: { title: 'Chief Scientist в Atla', description: `Вы — Chief Scientist в Atla!
...
Зарплата $250k–380k + equity. Помогают с визой и релокацией в Лондон.

Хотите откликнуться? Напишите @name.
Хотите ещё вакансий? У нас есть телеграм и джобборд.`, image: '/lunaparkmlquiz/assets/results/atla.png' },
  Safer: { title: 'Safer', description: 'Placeholder description for Safer.', image: '/lunaparkmlquiz/assets/results/recraft1.png' },
  Eternis: { title: 'ML Engineer в Eternis', description: `Вы — ML Engineer в Eternis!
...
Либо опыт как founding engineer, авторство заметного опенсорса или цитируемые статьи

Большой интерес к AI и понимание срочности происходящего

Зарплата $120k–800k + equity. Офис в Сан-Франциско, возможен ремоут, помогают с визой.

Хотите откликнуться? Напишите @name.
Хотите ещё вакансий? У нас есть телеграм и джобборд.`, image: '/lunaparkmlquiz/assets/results/eternis.png' },
  Epoch: { title: 'Epoch', description: 'Placeholder description for Epoch.', image: '/lunaparkmlquiz/assets/results/recraft1.png' },
  Metr: { title: 'ML Engineer в METR', description: `Вы — ML Engineer в METR!
...
Зарплата $150k–365k + виза без лотереи. Офис в Беркли, иногда возможен ремоут.

Хотите откликнуться? Напишите @name.
Хотите ещё вакансий? У нас есть телеграм и джобборд.`, image: '/lunaparkmlquiz/assets/results/metr.png' },
};
